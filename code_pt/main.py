...
print("Para baixar um post completo digite 3")
print("Para baixar todos os posts com imagens de um perfil digite 4")
print("Para baixar todos os posts de texto perfil digite 5")
print("Para baixar todas as DMs de um perfil digite 6")
...
if opcao == "1":
    ...
    # Executar script para baixar um post completo
